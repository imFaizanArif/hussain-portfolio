    ...
    return (
        <div className="w-full h-[606px]">
            <div className="">
                ...
                <a href="/" className='w-1/2 sm:w-1/2 lg:w-1/5 flex items-start justify-start font-semibold text-neutral-800 '><span className='pb-1.5 border-b-2 border-white hover:border-neutral-800'>Case Study</span> <Image src={rightArrow} alt="arrow-icon" width={22} height={22} className='ml-2' /> </a>
            </div>
        </div>
    )
}
