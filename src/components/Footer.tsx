    ...
    return (
        <footer className="text-neutral-800 body-font">
            <div className="container px-5 sm:px-5 md:px-20 pt-12  flex flex-wrap mx-auto items-center">
                <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-between w-full px-">
            ...
            <hr className="h-px mt-9 bg-neutral-300 border-0 w-[85%] mx-auto hidden md:block" />
            <div className="container mx-auto py-8 mb-5 sm:mb-5 md:mb-0 px-20 flex flex-wrap flex-col sm:flex-row items-center justify-center">
                <nav className="md:mr-auto hidden md:flex flex-wrap items-center text-base justify-center font-semibold space-x-5">
